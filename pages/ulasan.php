        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div>
                    ...
                    <a href="<?= ($level == 'user' ? '?page=peminjaman' : '?page=buku')?>" class="btn btn-md btn-info ms-3 mt-3">Kembali</a>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody class="text-center">
                                ...
                                $id = $_GET['id'];
                                $i = 1;
                                $query = mysqli_query($koneksi, "SELECT * FROM ulasan_buku LEFT JOIN user ON ulasan_buku.id_user=user.id_user LEFT JOIN buku ON ulasan_buku.id_buku=buku.id_buku WHERE ulasan_buku.id_buku='$id'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-info ms-3 mt-3" data-bs-toggle="modal" data-bs-target="#lihatulasan">
                                                Lihat Ulasan
                                            </button>
                                        </td>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="lihatulasan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"> ulasan dari <?= $data['nama_lengkap'] ?></h5>
